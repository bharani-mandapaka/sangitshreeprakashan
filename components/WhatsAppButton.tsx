...
export default function WhatsAppButton() {
  return (
    <motion.a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-2 bg-[#25D366] hover:bg-[#1ebe5a] text-white font-semibold text-sm px-4 py-3 rounded-full shadow-xl transition-colors group"
