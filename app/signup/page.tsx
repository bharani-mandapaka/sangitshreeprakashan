    ...
    <div className="min-h-screen bg-dark pt-20 lg:pt-24 flex items-center justify-center px-4 pb-16">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <p className="font-cinzel text-gold/70 text-xs uppercase tracking-[0.3em] mb-3">Join Us</p>
          <h1 className="font-cinzel text-3xl font-bold text-cream">Create Account</h1>
        </div>
