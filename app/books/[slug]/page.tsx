...
import { getBookBySlug, categoryMeta, books as allBooks } from '@/lib/books';
    ...
    <div className="min-h-screen bg-dark pt-20 lg:pt-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 xl:gap-20">
          ...
          >
            ...
            <div className="w-full grid grid-cols-2 gap-3 max-w-xs">
              {[
                ...
                { icon: <Award size={14} />,    label: 'Level',     value: levelLabels[book.level] },
                { icon: <Globe size={14} />,    label: 'Language',  value: langLabels[book.language] },
                ...
                <div key={spec.label} className="p-3 rounded-xl bg-[#0A0000] border border-gold/10">
                  <div className="flex items-center gap-1.5 text-gold/60 mb-1">
                    {spec.icon}
                    <p className="text-[10px] uppercase tracking-widest">{spec.label}</p>
                  </div>
          ...
          >
            {/* Breadcrumb */}
            <div className="flex items-center gap-2 text-cream/30 text-xs font-cinzel">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-gold text-xs font-cinzel uppercase tracking-widest">
                {meta.label}
              </span>
              {book.isBundle && (
            ...
            {book.authors.length > 0 && (
              <div>
                <p className="text-cream/40 text-xs uppercase tracking-widest mb-1 font-cinzel">Author{book.authors.length > 1 ? 's' : ''}</p>
                {book.authors.map((a) => (
            ...
            <div className="flex items-baseline gap-3">
              <span className="font-cinzel text-gold font-bold text-4xl">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <button
                ...
                className="flex-1 flex items-center justify-center gap-2.5 bg-gold hover:bg-gold-300 text-dark font-cinzel font-bold py-4 rounded-xl transition-colors text-base shadow-gold-sm hover:shadow-gold-glow"
              >
        ...
        {related.length > 0 && (
          <div className="mt-20">
            ...
            <h2 className="font-cinzel text-2xl font-bold text-cream mb-8">
              More in {meta.label}
            </h2>
